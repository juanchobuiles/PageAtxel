...
$asunto = "Mensaje enviado por formulario Contáctenos";
$comentarios = $_POST["comentarios_txa"];

$de="paginaweb@atxel.com";
$para="info@atxel.com , soporte1@atxel.com ";
$mensaje= "
<!DOCTYPE  html> 
<html lang='es'> 
<head>
...
<body> 
<h2>Desde el formulario Contáctenos ha llegado la siguiente solicitud</h2> 
<table style='font-size:13px; color:#000000; borde:thin solid #cccccc; margin: 1 auto; whidth:80%; text-aling:left;'>
        <tbody>
          ...
          <tr>
            <td bgcolor='#cccccc' style='color:#ffff; text-aling:left; width:2%;'><div><strong>CIUDAD: </strong></div></td>
            <td bgcolor='#F2F3F8'width='75%'>".$ciudad."</td>
          </tr>
          <tr>
